...
CREATE TABLE CLASSIFICATION (mem_id varchar(10), com_rate DOUBLE(10,3), Primary Key (mem_id));CREATE TABLE CLASSIFICATION (mem_id varchar(10), com_rate DOUBLE(10,3), Primary Key (mem_id));*/
...
CREATE TABLE NFT (t_id varchar(10),NFT_id varchar(10),NFT_add VARCHAR(50),NFT_value DOUBLE(10,3),name varchar(50),sell_add varchar(50), prevSellAdd varchar(50), URL VARCHAR(2083), Primary KEY (NFT_id));
