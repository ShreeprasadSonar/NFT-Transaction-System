...
USE nft_system;
CREATE TABLE TRADER (t_id varchar(10), t_name varchar(50),pass varchar(50),fiat_amt DOUBLE(10,3),Ph_no varchar(20),cell_no varchar(20),email varchar(50),mem_type varchar(10),eth_add varchar(50),eth_cnt int(10),Primary key (t_id,email));
