...
USE nft_system;
CREATE TABLE TRADER (t_id varchar(10), t_name varchar(50),pass varchar(50),fiat_amt DOUBLE(10,3),Ph_no BIGINT(12),cell_no BIGINT(12),email varchar(50),mem_type varchar(10),eth_add varchar(50),eth_cnt int(10),Primary key (t_id));
